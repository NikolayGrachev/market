package ru.grachev.market.core_utils.presentation.decorator
...
/**
 * From https://blog.davidmedenjak.com/android/2017/06/24/viewpager-recyclerview.html
 */
class IndicatorDecorator(context: Context) : RecyclerView.ItemDecoration() {
    private val colorActive = context.getColor(R.color.teal_200)
    private val colorInactive = context.getColor(R.color.teal_700)
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val itemCount: Int = parent.getAdapter()?.getItemCount() ?: 0
